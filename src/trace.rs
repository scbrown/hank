...
pub struct ConstraintEvaluation {
    ...
    /// Grounding resolver state (`used`, `empty`, `missing`, etc.).
    #[serde(skip_serializing_if = "Option::is_none")]
...
impl ConstraintEvaluation {
    ...
    /// Bind a grounding evaluation to its content-addressed evidence context.
    #[must_use]
    pub fn grounded(
        mut self,
        reference: &crate::grounding::GroundingRef,
        outcome: &crate::grounding::GroundingState,
    ) -> Self {
